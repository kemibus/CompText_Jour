...
=======
library(lubridate)
>>>>>>> 4cdcc2e0d4fc1f21e1cc09a90c14bc7b142b395e
```
...
ggplot(days,aes(x = days, y = n,
fill = n)) +#  geom_col(position = "dodge") + theme(legend.position = "none")
...
#Using the summary() function, describe the minimum,
...
The day with the most call is 2019-08-15.
...
```{r}
Dates<-read.csv("https://github.com/profrobwells/Data-Analysis-Class-Jour-405v-5003/blob/master/Readings/dealing-with-dates.")
```
